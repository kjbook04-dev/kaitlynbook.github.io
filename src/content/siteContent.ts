export const siteContent = {
  ...
  blog: [
    {
      title: "Designing Calm Interfaces in High-Pressure Products",
      excerpt: "A framework for bringing clarity and composure to fast-paced digital experiences.",
      date: "2025-12-10",
      tags: ["UX", "Strategy"],
      slug: "designing-calm-interfaces"
    },
    {
      title: "The Quiet Power of Visual Systems",
      excerpt: "Why consistent, elegant systems are the fastest path to trust.",
      date: "2025-10-24",
      tags: ["Systems", "Design"],
      slug: "quiet-power-visual-systems"
    },
    {
      title: "A Boutique Approach to Product Roadmaps",
      excerpt: "How to scale with intention instead of complexity.",
      date: "2025-09-01",
      tags: ["Leadership", "Process"],
      slug: "boutique-product-roadmaps"
    },
    {
      title: "Designing for Conversion Without Pressure",
      excerpt: "Elegant persuasion techniques that respect users.",
      date: "2025-07-15",
      tags: ["UX", "Growth"],
      slug: "conversion-without-pressure"
    }
  ],
  // REPLACE THIS WITH YOUR INFO
  resources: [
  ...
  hubCards: [
    {
      title: "About",
      description: "Background, values, and current focus.",
      href: "/about",
      icon: "user"
    },
    {
      title: "Experience",
      description: "Timeline of roles and impact.",
      href: "/experience",
      icon: "briefcase"
    },
    {
    ...
    {
      title: "Blog",
      description: "Writing on product, systems, and craft.",
      href: "/blog",
      icon: "pen-line"
    },
    {
      title: "Resources",
      description: "Templates, tools, and learning vault.",
      href: "/resources",
      icon: "folder-heart"
    },
    {
